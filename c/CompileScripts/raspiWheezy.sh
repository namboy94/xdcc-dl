...
OBJECTS="../Objects/Config.h ../Objects/Config.cpp ../Objects/ServerList.h ../Objects/ServerList.cpp ../Objects/Bot.cpp ../Objects/Channel.cpp ../Objects/Server.cpp ../Objects/Pack.cpp ../Objects/Locator.cpp"
