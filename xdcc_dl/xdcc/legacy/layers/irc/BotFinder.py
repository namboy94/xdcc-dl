...
class BotFinder(IrcEventPrinter):
    ...
    def on_welcome(self, connection: irc.client.ServerConnection,
        ...
        self.logger.log("Sending WHOIS command for " +
    ...
    def on_whoischannels(self, connection: irc.client.ServerConnection,
                         event: irc.client.Event):
        """
        ...
        self.logger.log("Received WHOIS information, bot resides in: " +
    ...
    def on_nosuchnick(self, connection: irc.client.ServerConnection,
                      event: irc.client.Event):
        """
        ...
        if event.arguments[0] == self.current_pack.get_bot():
            self.logger.log("Bot " + self.current_pack.get_bot() +
                            " does not exist on Server", LOG.WHOIS_NO_RESULT)
            raise BotNotFoundException()

    def on_whoisuser(self, connection: irc.client.ServerConnection,
                     event: irc.client.Event):
        """
    ...
    def on_whoisserver(self, connection: irc.client.ServerConnection,
                       event: irc.client.Event):
        """
